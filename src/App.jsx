...
const CONTRACT_ADDRESS = "0xdFe6F374eb87478F401cF14AdD67d5Ff8cB06489"; 
...
export function App( props ) {  
    ...
    return (
        <Container style={{ padding:"0px", border:"1px solid grey",width:"2500px"}}>
            ...
            <Row>
                ...
                <Col style={{ "paddingRight":"0px", "borderRight":"2px solid #000000" }}>
                    <div style={{ "backgroundColor":"#FFE6E8", "height":"100%", overflowY:"auto"}}>
                          <Row style={{ marginRight:"0px" }}>
                              <Card style={{ width:'100%', alignSelf:'center', marginLeft:"15px" ,backgroundColor:"#DCDCDC",borderRadius:"0px"}}>
                                <Card.Header style={{fontSize:"22px",fontWeight:"bold",fontFamily:"TimesNewRoman",color:"black",height:"45px",textAlign:"center",borderColor:"black"}} >
                                    Chats
                                </Card.Header>
                              </Card>
                          </Row>
                ...
                <Col xs={ 8 } style={{ "paddingLeft":"0px" }}>
                    <div style={{ "backgroundColor":"#DCDCDC", "height":"100%" }}>
                        ...
                        <Row style={{ marginRight:"0px" }}>
                              <Card style={{ width:'100%', alignSelf:'center', margin:"0 0 5px 15px" ,height:"45px",backgroundColor:"#DCDCDC" }}>
                                <Card.Header style={{height:"45px"}}>
                                    { activeChat.friendname } : { activeChat.publicKey }
                                    <Button style={{ float:"right",borderRadius:"10px",marginTop:"-5px",fontsize:"10px" }} variant="transparent" onClick={ () => {
                                        if( activeChat && activeChat.publicKey )
                                            getMessage( activeChat.publicKey );
                                    } }>
                                        <img style={{height:"20px",width:"20px"}}src="https://w7.pngwing.com/pngs/365/764/png-transparent-computer-icons-refresh-free-one-button-reload-text-logo-monochrome-thumbnail.png"></img>
                                    </Button>
                                </Card.Header>
                            </Card>
                        </Row>
                        {/* The messages will be shown here */}
                        <div className="MessageBox" style={{ height:"450px",overflowY:"auto",marginTop:"-10px",backgroundImage:'url("https://wallpapercave.com/wp/wp10254485.jpg")',backgroundRepeat:"no-repeat",backgroundSize:"110%"}}>
                           { Messages }
                        </div>
                        {/* The form with send button and message input fields */}
                        <div className="SendMessage"  style={{ borderTop:"2px solid black", position:"relative", bottom:"0px", padding:"10px 45px 0 45px", margin:"0 95px 0 0", width:"100%",height:"55px",backgroundColor:"black" }}>
                            <Form  onSubmit={ (e) => {
                                e.preventDefault();
                                ...
                                <Form.Row className="align-items-center" >
                                    <Col xs={9} style={{margin:"-15px",marginBottom:"-10px"}}>
                                        <Form.Control id="messageData" className="mb-2"  placeholder="Send Message....." style={{borderRadius:"50px"}}/>
                                    </Col>
                                    <Col >
                                      <Button className="mb-2" style={{ marginLeft:"20px",backgroundColor:"black",borderRadius:"50%",height:"40px",width:"40px",marginTop:"-3px",padding:"0px",backgroundColor:"white"}} onClick={ () => {
                                          sendMessage( document.getElementById( 'messageData' ).value );
                                          document.getElementById( 'messageData' ).value = ""; 
                                          <img src="C:\Users\Vivitha\Downloads\send.jpg"
                                          style={{height:"50px",width:"50px",borderRadius:"50%"}}></img>;
                                      }}>
                                        <img src="https://cdn-icons-png.flaticon.com/512/60/60525.png"
                                        style={{height:"30px",width:"30px",borderRadius:"50%"}}></img>
                                      </Button>
                                    </Col>
                                </Form.Row>
                            </Form>
